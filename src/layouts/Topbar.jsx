  ...
  return (
    <header className="h-14 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm flex items-center justify-between px-6 max-md:px-3 shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        {onTestWaterSound && (
          <button
            onClick={onTestWaterSound}
            className="p-2 rounded-xl text-slate-400 hover:text-cyan-600 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 dark:hover:text-cyan-400 transition-colors"
            title="Test water reminder sound"
          >
